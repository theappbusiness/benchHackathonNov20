...
//        SharedPreferenceUtil.saveLocationTrackingPref(this, true)
        ...
        startService(Intent(applicationContext, MyNavigationService::class.java))
...
//            SharedPreferenceUtil.saveLocationTrackingPref(this, true)
    ...
    private fun generateNotification(location: Location?): Notification {
        ...
        val cancelIntent = Intent(this, MyNavigationService::class.java)
    ...
    inner class LocalBinder : Binder() {
        internal val service: MyNavigationService
            get() = this@MyNavigationService
    }
