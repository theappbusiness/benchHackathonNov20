...
public struct Strings { // TODO: these can all be public enums, plus public extensions will help reduce the need to add `public` everywhere
	...
	public struct SignUp {
		public static let welcomeScreenTitle = "Hello!"
		public static let welcomeScreenInfo = "Community Kitchen helps provide free food to those who need it by enabling the community to share extra or unwanted food"
		public static let welcomeButtonTitle = "Register with email"
		
		public static let registerWithEmailTitle = "Email"
		public static let registerWithEmailPlaceHolder = "Enter your email address"
		public static let registerWithEmailInfo = "First we ll need to know the email address you want to sign up with \n We will never share your email with any 3rd parties or send you any emails you dont request"
		public static let registerWithEmailButtonTitle = "Continue to password"


		public static let registerWithPasswordTitle = "Password"
		public static let registerWithPasswordInfo = "Next please choose a strong password. \n We recommend using a strong password generated by password mamnager"
		public static let registerWithPasswordButtonTitle = "Register"
