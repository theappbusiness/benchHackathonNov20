...
class MealsSDK {
    ...
    @Throws(Exception::class) suspend fun getMeals(userLat: Double, userLon: Double, inMiles: Boolean, forceReload: Boolean): List<MealWithDistance> {
        return api.getAllMeals(userLat, userLon, inMiles)
    }
